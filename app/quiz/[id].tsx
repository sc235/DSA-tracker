    ...
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingSubtext}>
          Generating dynamic adaptive assessment
        </Text>
      </View>
    );
  }
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.finishedContainer}>
          <View style={styles.finishedBadge}>
            <Trophy
              color={isMastery ? Theme.colors.warning : Theme.colors.primary}
              size={36}
            />
          </View>
          ...
          <Text style={styles.finishedSubtitle}>
            AlgoPlatform Assessment Report
          </Text>
          ...
          <View style={styles.cardContainer}>
            ...
            <View style={styles.feedbackBox}>
              <ShieldCheck
                color={isMastery ? Theme.colors.success : Theme.colors.warning}
                size={24}
              />
              <View style={styles.feedbackTextCol}>
                <Text style={styles.feedbackStatus}>
                  {isMastery ? "Mastery Verified" : "Review Recommended"}
                </Text>
          ...
          <View style={styles.finishedActionCol}>
            <TouchableOpacity
              ...
              onPress={() => {
                setIsLoading(true);
                setTimeout(() => {
                  const freshQuestions = AIQuizService.generateQuiz(
                    id as string,
                    10,
                  );
